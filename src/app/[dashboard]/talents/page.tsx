...
import { mockCompanies, mockTalents } from "../components/mock/mock";
import TalentsTable, { talentsColumns } from "./components/TalentsTable";
    ...
    <div className="w-full flex flex-col">
      <div className="p-8 flex flex-col gap-1">
        ...
        <p className="text-gray-500">
          View all talents and manage all talents here.
        </p>
        {/* Tabs and Controls */}
        <div className="mb-6">
          {/* Tabs */}
        ...
        {/* Table */}
        <div className="mb-4">
          <h2 className="text-lg font-medium text-gray-900">All talents</h2>
        </div>
        <TalentsTable
