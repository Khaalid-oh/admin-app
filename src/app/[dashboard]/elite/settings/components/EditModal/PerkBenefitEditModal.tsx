...
import { BaseEditProps, PerkBenefitData } from "../../types";

export const PerkBenefitEditModal: React.FC<BaseEditProps> = ({
  isOpen,
  onClose,
  onUpdate,
  initialData,
}) => {
  const [formData, setFormData] = useState<PerkBenefitData>(
    initialData || {
      name: "",
      perks: [],
      regions: [],
      ...
      <div className="space-y-4">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">
            Edit Perk and Benefit
          </h2>
          <p className="text-sm text-gray-500">
            Edit Details of perks you want to provide to companies to select
            from
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Select the perks that would be available on this plan
            </label>
            <div className="mt-2 flex flex-wrap gap-2">
              {formData.perks.map((perk) => (
                ...
                >
                  <span className="text-sm text-blue-700">{perk}</span>
                  <button
                    onClick={() =>
                      setFormData({
                        ...formData,
